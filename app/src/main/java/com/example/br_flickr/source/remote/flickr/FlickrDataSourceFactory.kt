...
class FlickrDataSourceFactory(private val searchQuery: String, private val flickrDB: FlickrDB)
    ...
    override fun create(): DataSource<Int, Photo> {
        val source = FlickrPageKeyedDataSource(flickrApi, searchQuery, flickrDB)
